...
TARGET_PREBUILT_DTB := device/motorola/lima/prebuilt/dtb.img
...
BOARD_AVB_RECOVERY_AS_BOOT := true
BOARD_AVB_BOOT_KEY_PATH := external/avb/test/keys/avb_pkmd.pem
BOARD_AVB_BOOT_ADD_PIK_FROM_AVB := true
BOARD_AVB_BOOT_ADD_PYK_FROM_AVB := true
BOARD_AVB_BOOT_ROLLBACK_INDEX := $(PLATFORM_SECURITY_PATCH)
BOARD_AVB_BOOT_ROLLBACK_INDEX_LOCATION := 0
BOARD_AVB_RECOVERY_KEY_PATH := $(BOARD_AVB_BOOT_KEY_PATH)
BOARD_AVB_RECOVERY_ROLLBACK_INDEX := $(BOARD_AVB_BOOT_ROLLBACK_INDEX)
BOARD_AVB_RECOVERY_ROLLBACK_INDEX_LOCATION := $(BOARD_AVB_BOOT_ROLLBACK_INDEX_LOCATION)
BOARD_AVB_ALGORITHM := SHA256_RSA2048
BOARD_AVB_HAS_AVB_FOOTER := true
